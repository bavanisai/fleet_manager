...
public class RemindersDbAdapter {
    ...
    /**
     * Create a new reminder using the title, body and reminder date time
     * provided. If the reminder is successfully created return the new rowId
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[]{KEY_ROWID, KEY_TITLE,
                KEY_BODY, KEY_DATE_TIME}, null, null, null, null, KEY_TITLE
                + " ASC");
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[]{KEY_ROWID, KEY_TITLE,
                                KEY_BODY, KEY_DATE_TIME}, KEY_ROWID + "=" + rowId, null, null,
                        null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }

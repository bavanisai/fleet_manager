...
public class DriverEntryActivity extends ActionBarActivity implements
        OnNavigationListener
{
    ...
    CharSequence Titles[] = {"DRIVER LIST", "ADD/UPDATE DRIVER"};
    int Numboftabs = 2;
    Spinner spinner;
    Toolbar toolbar;
    static int pos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(toolbar.getContext(), R.array.ManageResource2, R.layout.support_simple_spinner_dropdown_item);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 1:
                        Intent in1 = new Intent(DriverEntryActivity.this, CleanerEntryActivity.class);
                        startActivity(in1);
                        finish();
                        break;
                    case 2:
                        Intent in2 = new Intent(DriverEntryActivity.this, MainActivity.class);
                        startActivity(in2);
                        finish();
                        break;
                }

...
public class AddCleaner extends Fragment implements IManageResourcesCleaner {
    ...
    IManageResourcesCleaner mInterfaceManageResourcesCleaner = this;
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (drvName.equals("")) {
                        ...
                        db.open();
                        LocalEmpId = db.checkCleanerTableforDataExist(drvName);
    ...
    public void setMenuVisibility(final boolean visible) {
        ...
        if (visible) {
            if (CleanerList.DriverName != null) {
                switch (CleanerList.DriverName) {
                    case "refresh":
                        refreshActivity();
                        break;
                    ...
                    default:
                        ...
                        populate(CleanerList.DriverName);
                        break;
                }
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            Toast.makeText(getActivity(), "Capture Photo Cancelled",
                    Toast.LENGTH_LONG).show();
    ...
    public byte[] getBytesFromBitmap(ImageView DriverPhoto2) {
        try {
            ...
            Toast.makeText(getActivity(), "Error while Uploading Photo",
                    Toast.LENGTH_SHORT).show();
            ExceptionMessage.exceptionLog(getActivity(), this.getClass()
                    .toString() + " " + "[getBytesFromBitmap]", e.toString());
        }
        return byteArray;
    }
    ...
    private void alertUpdate()
    {
        ...
        message.setText("Update "+CleanerList.DriverName+" ?");
        ...
        ok.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view)
            {
                SendToWebService send = new SendToWebService(getActivity(),
                        mInterfaceManageResourcesCleaner);
                send.execute("10", "ManageEmployee", "Cleaner", drvName,
    ...
    public void refreshActivity() {
        ...
        Intent intent = new Intent(getActivity(), CleanerEntryActivity.class);
    ...
    public void populate(String driName) {
        try {
            ...
            Cursor cursor = db.getCleanerEntry(driName);
            if (cursor.moveToFirst()) {
                // update view
